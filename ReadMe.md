...
Note that the total number of images in the training set is ![](https://latex.codecogs.com/svg.latex?n\times8\times%20\text{crop-num}), and each image is of size ![](https://latex.codecogs.com/svg.latex?\text{crop-size}\times\text{crop-size}).
